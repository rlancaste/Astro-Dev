...
# Get the commit message, commit the changes, and make a pull request.
	...
	git push
	display "Please go to https://github.com/${FORKED_THIRDPARTY_REPO} and click the submit pull request button if you are ready to make your pull request, or make other changes and other commits first."

...
#	AstroDev.sh - A Script to submit changes to THIS Repo, the Astro-Dev one
#﻿  Copyright (C) 2025 Robert Lancaster <rlancaste@gmail.com>
...
# This section sets the critical options for finding the repo and forked src folder.
	export PACKAGE_NAME="Astro-Dev"
	export PACKAGE_SHORT_NAME="Astro-Dev"

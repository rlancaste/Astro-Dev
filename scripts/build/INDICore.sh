...
# 	INDICore.sh - A Script meant to build the INDI Core Drivers with the requested options.
...
# This section sets the options for building the package.
	...
	export UBUNTU_DEPENDENCIES="cmake git build-essential zlib1g-dev libcfitsio-dev libusb-1.0-0-dev libtheora-dev libcurl4-gnutls-dev libgsl-dev libjpeg-dev libfftw3-dev libev-dev"

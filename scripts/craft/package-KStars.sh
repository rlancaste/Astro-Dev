...
# 	package-KStars.sh - This script uses craft to rebuild and package KStars
...
# These are the major script options.  Set these to the options you prefer by commenting them or uncommenting them with a #.
	...
	# These are the options for which dependencies you want craft to rebuild.  Comment out any you don't want with a #.
		REBUILD_INDI_DRIVERS="Yep"
		REBUILD_STELLARSOLVER="Yep"
